...
100% safe implementation - no schema changes, existing models only
    ...
    def get_backup_status(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                'disk_space': self._get_disk_space() if os.path.exists(self.backup_dir) else None
            }
...
def backup_health_check() -> Dict[str, Any]:
    ...
    try:
        ...
        disk_space = status.get('disk_space', {})
        if disk_space.get('free_bytes', 0) < 100 * 1024 * 1024:  # Less than 100MB
            return {'status': 'warning', 'message': 'Low disk space for backups'}
