...
--
-- Name: monthly_summaries; Type: TABLE; Schema: public; Owner: neondb_owner
--
...
ALTER TABLE public.monthly_summaries OWNER TO neondb_owner;

--
-- Name: monthly_summaries_id_seq; Type: SEQUENCE; Schema: public; Owner: neondb_owner
--
...
ALTER SEQUENCE public.monthly_summaries_id_seq OWNER TO neondb_owner;

--
-- Name: monthly_summaries_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: neondb_owner
--
...
--
-- Name: monthly_summaries id; Type: DEFAULT; Schema: public; Owner: neondb_owner
--
...
--
-- Data for Name: monthly_summaries; Type: TABLE DATA; Schema: public; Owner: neondb_owner
--
...
--
-- Name: monthly_summaries_id_seq; Type: SEQUENCE SET; Schema: public; Owner: neondb_owner
--
...
--
-- Name: monthly_summaries monthly_summaries_pkey; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: users users_user_id_hash_key; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: idx_expenses_user_id_created_at; Type: INDEX; Schema: public; Owner: neondb_owner
--
...
--
-- Name: idx_users_user_id_hash; Type: INDEX; Schema: public; Owner: neondb_owner
--
